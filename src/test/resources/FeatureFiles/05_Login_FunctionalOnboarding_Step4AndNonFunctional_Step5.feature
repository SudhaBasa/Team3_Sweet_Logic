Feature: Functional test for Onboarding Step 4 and non functional scenarios for Step 5
  ...
  Background: 
    User should have completed until step 3 in onboarding process
  ...
  Scenario: Validate user able to select from option in centimeters
    ...
    Then User should redirect to Step 5
  ...
  Scenario: Verify the functionality of the Back button in Step 4
    Given User is in Step 4
    When User clicks back button in step 4
    Then User should redirected to step 3

  Scenario: Ensure the heading for Step 5 is visible
    Given User is in Step 4
    When User selects from options available in feet & inches
    Then Page should display title "How much awesome do you weigh?"

  Scenario: Verify the subtext displayed in Step 5
    Given User is in Step 4
    When User selects from options available in feet & inches
    Then User should see sub text "We will personalize your nutrition plan to guide you towards your goals!"
